...
ThemeData nativeTheme() {
  return ThemeData(
      ...
      primaryColorLight: Color(0xFF660033), 
      // primaryColorDark: Color(0xFFFF6860),
      primaryColorDark: Color(0xFF990066),
      // primarySwatch: MaterialColor(0xFFFF6860, color),
      primarySwatch: MaterialColor(0xFF990066, color),
      primaryIconTheme: IconThemeData(color: Colors.white),
      // iconTheme: IconThemeData(color: Color(0xFFFF6860)),
      iconTheme: IconThemeData(color: Color(0xFF990066)),
      ...
      primaryTextTheme: TextTheme(
        ...
        headline1: TextStyle(fontSize: 15, color: Color(0xFF990066)),
      ...
      floatingActionButtonTheme: FloatingActionButtonThemeData(
        ...
        backgroundColor: Color(0xFF990066),
      ),
      textButtonTheme: TextButtonThemeData(
        ...
        backgroundColor: MaterialStateProperty.all(Color(0xFF990066)),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        ...
        side: MaterialStateProperty.all(BorderSide(color: Color(0xFF990066), width: 1.5)),
        // textStyle: MaterialStateProperty.all(TextStyle(fontSize: 16, color: Color(0xFFFF6860), fontWeight: FontWeight.w400)),
        textStyle: MaterialStateProperty.all(TextStyle(fontSize: 16, color: Color(0xFF990066), fontWeight: FontWeight.w400)),
        shape: MaterialStateProperty.all(RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(5),
        )),
      )),
      dialogTheme: DialogTheme(
        ...
        titleTextStyle: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF990066)),
      ),
      ...
      buttonTheme: ButtonThemeData(
        ...
        buttonColor: Color(0xFF990066),
        // focusColor: Color(0xFFFF6860),
        focusColor: Color(0xFF990066),
        // highlightColor: Color(0xFFFF6860),
        highlightColor: Color(0xFF990066),
        // hoverColor: Color(0xFFFF6860),
        hoverColor: Color(0xFF990066),
        // splashColor: Color(0xFFFF6860),
        splashColor: Color(0xFF990066),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: Color(0xFF990066)),
          borderRadius: BorderRadius.all(Radius.circular(10.0)),
        ),
        filled: true,
      ...
      appBarTheme: AppBarTheme(
        ...
        actionsIconTheme: IconThemeData(color: Color(0xFF990066), size: 30),
        // iconTheme: IconThemeData(color: Color(0xFFFF6860), size: 24),
        iconTheme: IconThemeData(color: Color(0xFF990066), size: 24),
      ),
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        fillColor: MaterialStateProperty.all(Color(0xFF990066)),
      ));
}
