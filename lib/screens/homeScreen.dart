...
import 'package:vizitland_partner/screens/notificationScreen.dart';
                                ...
                                Container(
                                  ...
                                  child: Stack(children: [
                                    ...
                                    Sinusoidal(
                                      ...
                                      child: Container(height: 40, color: Color(0xFFFA692C)),
                                    ),
                                    Sinusoidal(
                                      model: const SinusoidalModel(
  ...
  _charts() {
    final barGroups = <BarChartGroupData>[
      BarChartGroupData(
        x: 15,
        barRods: [
          BarChartRodData(y: y1, color: Color(0xFF47505F), width: 22, borderRadius: BorderRadius.zero),
        ],
      ),
      BarChartGroupData(
        x: 15,
        barRods: [
          BarChartRodData(y: y2, color: Color(0xFFF44336), width: 22, borderRadius: BorderRadius.zero),
        ],
      ),
      BarChartGroupData(
        x: 15,
        barRods: [
          BarChartRodData(y: y3, color: Color(0xFF4CAF50), width: 22, borderRadius: BorderRadius.zero),
        ],
      ),
      BarChartGroupData(
        x: 15,
        barRods: [
          BarChartRodData(y: y4, color: Color(0xFFFDEB3B), width: 22, borderRadius: BorderRadius.zero),
        ],
      ),
      BarChartGroupData(
        x: 15,
        barRods: [
          BarChartRodData(y: y5, color: Color(0xFf40C4FF), width: 22, borderRadius: BorderRadius.zero),
        ],
      ),
      BarChartGroupData(
        x: 15,
        barRods: [
          BarChartRodData(y: y6, color: Color(0xFFE91E64), width: 22, borderRadius: BorderRadius.zero),
        ],
      ),
      BarChartGroupData(
        x: 15,
        barRods: [
          BarChartRodData(y: y7, color: Color(0xFF9C27B0), width: 22, borderRadius: BorderRadius.zero),
        ],
      )
    ];
