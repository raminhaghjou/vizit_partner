...
class _GeneralInformationScreenState extends BaseRouteState {
  ...
  signUp() async {
    try {
      ...
      if (_cVenderName.text.isNotEmpty && _cPhoneNumber.text.isNotEmpty && _cPhoneNumber.text.length == 11 && _cOwnerName.text.isNotEmpty && _cAddress.text.isNotEmpty && _cDescription.text.isNotEmpty && _tImage != null) {
      ...
      } else if (_cPhoneNumber.text.length != 11) {
