...
import 'package:vizitland_partner/screens/addServicesScreen.dart';
...
class _ServiceListScreenState extends BaseRouteState {
                                                      ...
                                                      Container(
                                                        ...
                                                        child: ClipRRect(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            height: 70,
                                                            width: 70,
                                                            child: (_serviceList[index].service_image == 'N/A' || _serviceList[index].service_image == null)
                                                                ? Image.asset(
  ...
  Widget _serviceVariant1(int index) {
    try {
      ...
      List<AccessVarients> _accessVarientsList = [];
