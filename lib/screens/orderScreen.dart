...
import 'package:vizitland_partner/widgets/bottomNavigationBar.dart';
                                                      ...
                                                      children: [
                                                        GestureDetector(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            width: 130,
                                                            decoration: BoxDecoration(
                                                                color: _orderList[index].statustext == "Pending" //AppLocalizations.of(context).lbl_pending //
                                                                    ? Colors.amber
                                                                    : _orderList[index].statustext == "Completed" //AppLocalizations.of(context).lbl_completed //"Completed"
                                                                        ? Colors.green[600]
    ...
    try {
      showDialog(
          ...
          builder: (_) {
            return AlertDialog(
              title: Text(
                AppLocalizations.of(context).lbl_pending_order,
              ),
              content: Text(
                AppLocalizations.of(context).lbl_orderConfirmationDialog,
              ),
              actions: [
                TextButton(
                  child: Padding(
                    ...
                    child: Text(
                      AppLocalizations.of(context).lbl_complete_order,
                    ),
                  ),
                  onPressed: () async {
                    Navigator.of(context).pop();
